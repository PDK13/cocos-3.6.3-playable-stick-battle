...
@ccclass('StickAngel')
export class StickAngel extends StickController {
    @property(CCInteger)
    ...
    readonly ANIM_IDLE: string = 'idle_1';
    readonly ANIM_MOVE: string = 'walk';
    ...
    protected start(): void {
        ...
        //
        director.on(GameEvent.BATTLE_START, this.OnBattleStart, this);
        //
        ...
        //
        if (this.isTeam())
            director.on(GameEvent.STICK_RED_DEAD, this.onEnermyDead, this);
        else
            director.on(GameEvent.STICK_BLUE_DEAD, this.onEnermyDead, this);
    }
    ...
    private onBeginContact(selfCollider: Collider2D, otherCollider: Collider2D, contact: IPhysics2DContact | null) {
        ...
        switch (selfCollider.tag) {
            case GameTag.TAG_FIELD_RENDERER:
                //-------------------------------------------------
                ...
                break;
            //=========================================================
            case GameTag.TAG_FIELD_RANGE:
                switch (otherCollider.tag) {
                    //-------------------------------------------------
                    case GameTag.TAG_FIELD_BODY:
