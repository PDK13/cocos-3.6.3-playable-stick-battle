...
export class StickController extends Component {
    ...
    protected onLoad(): void {
        ...
        //
        director.on(GameEvent.BATTLE_END, this.onBattleEnd, this);
    }
    ...
    public SetDead(): void {
        ...
        //
        if (this.isTeam())
            director.emit(GameEvent.STICK_BLUE_DEAD, this.node);
        else
            director.emit(GameEvent.STICK_RED_DEAD, this.node);
        //
